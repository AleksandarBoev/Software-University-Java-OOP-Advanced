...
public class HeroInventory implements Inventory {
    ...
    private void checkRecipes() {
        for (Recipe recipe : this.recipeItems.values()) {
            List<String> requiredItems = new ArrayList<String>(recipe.getRequiredItems()); //working with a copied list, not with the actual one
...
//        this.recipeItems.remove(recipe.getName()); //completed recipe shouldn't be removed from the recipe collection
    }
}