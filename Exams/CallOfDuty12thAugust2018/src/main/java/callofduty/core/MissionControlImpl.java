...
public class MissionControlImpl implements MissionControl { //TODO to be unit tested
    private static final Integer MISSION_ID_MAXIMUM_LENGTH = 8; //TODO was 6
    ...
    private static final Double MISSION_BOUNTY_MAXIMUM_VALUE = 100000D; //TODO was 1 000 000 now is 100 000
    ...
    private Double checkAndReformMissionRating(Double missionRating) {
        return missionRating < MISSION_RATING_MINIMUM_VALUE
                ...
                : (missionRating > MISSION_RATING_MAXIMUM_VALUE //TODO was <
                ? MISSION_RATING_MAXIMUM_VALUE
                : missionRating);
    }

    private Double checkAndreformMissionBounty(Double missionBounty) {
        return missionBounty < MISSION_BOUNTY_MINIMUM_VALUE //TODO was >
                ? MISSION_BOUNTY_MINIMUM_VALUE
                : (missionBounty > MISSION_BOUNTY_MAXIMUM_VALUE //TODO was <
                ? MISSION_BOUNTY_MAXIMUM_VALUE
                : missionBounty);
    }

    private void updateMissionType() {   //should be named reset/restart or something like that, not update...
        this.missionIterator = this.missionClasses.entrySet().iterator();
    }

    private Class currentMission() {
        if (!this.missionIterator.hasNext()) { //TODO didn't have "!" unit test if the generated missions change as they should!
    ...
    public Mission generateMission(String missionId, Double missionRating, Double missionBounty) {
        ...
        Mission generatedMission =
                this.instantiateMissionObject(missionId, missionRating, missionBounty); //TODO mission bounty and mission rating were swapped
