...
public class Main {
    public static void main(String[] args) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, IOException {
        ...
        Method sayHelloMethod = SomeClass.class.getMethod("sayHello", null); //null means it has no parameters
        ...
        Method someMethodWith2Params = SomeClass.class.getMethod("someMethod", String.class, String.class);
        ...
        int result = (int)sumAsciiLettersMethod.invoke(someClass);
